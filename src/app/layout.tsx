...
export const metadata: Metadata = {
  title: "AIESEC In Uganda - global platform for young people to develop their leadership potential",
  description: "AIESEC is a global platform for young people to develop their leadership potential through practical experiences.",
};
